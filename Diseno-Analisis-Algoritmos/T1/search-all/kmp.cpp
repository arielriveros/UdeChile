/*code by Prayas Sambhare @ https://www.codespeedy.com/knuth-morris-pratt-kmp-algorithm-in-c/ */
...
void KMP(string text, string pattern){
    ...
    while(i<n){
        ...
        if (j == m) { 
            cout << "Pattern found at position: " <<i - m << endl;    // if j==m it is confirmed that we have found the pattern and we output the index
