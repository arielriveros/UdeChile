...
class Doctor:
    ...
    def __init__(self, database="cc5002", host="localhost",  user="root", password=""):
    ...
    def save_doctor(self, data, fileObj):
        ...
        sqlQuery = """ 
            INSERT INTO archivo (nombre,file) values (%s,%s)
         """
        ...
        VALUES (%s,%s,%s,%s,%s,%s);
        """
        self.cursor.execute(sqlQuery, (*data,id_foto))
        self.db.commit()
